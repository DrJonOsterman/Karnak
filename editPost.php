...
<tr> 
    <td>Title:</td>
    <td><input type="text" name="title" value="<?php echo $postToEdit['postTitle'];?>" /></td>
</tr>

<tr>
    <td>Type:</td>
    <td><input type="text" name="type" value="<?php echo $postToEdit['postType'];?>" /></td>
</tr>

<tr>
    <td>Tags:</td>
    <td> <input type="text" name="tags" value="<?php echo $postToEdit['postTags'];?>"/></td>
</tr>

<tr>
    <td>Body:</td>
    <td><textarea name="content"><?php echo $postToEdit['postContent'];?></textarea></td>
</tr>
